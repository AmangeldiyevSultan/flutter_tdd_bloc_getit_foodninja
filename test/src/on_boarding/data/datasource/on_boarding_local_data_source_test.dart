...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    test(
        ...
        'there is an error cahcing the data', () async {
      when(
        () => prefs.setBool(any(), any()),
      ).thenThrow(Exception());
  ...
  group('checkIfUserIsFirstTimer', () {
    ...
    test('should return true if there is no data on storage', () async {
    ...
    test(
      ...
      expect(methodCall, equals(throwsA(isA<CacheException>())));
